      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="mt-6 text-lg text-white/80 max-w-2xl mx-auto">
            New batch starting soon — limited seats available! Book a free
            consultation now and take the first step towards your dream career in
            Japan.
          </p>
          ...
          >
            ...
            <span className="text-white/90 text-sm font-medium">
              🔥 Only 25 seats remaining for the April batch
            </span>
          </motion.div>
        </motion.div>
      </div>
